...
/*   Updated: 2025/01/17 11:41:41 by quenalla         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	count_elements(t_map *map, int *player, int *exit, int *collectable)
{
	int	y;
	int	x;
...
int	validate_element(t_map *map)
{
	...
	exit = 0;
	collectable = 0;
	if (!count_elements(map, &player, &exit, &collectable))
		return (0);
	if (player != 1)
